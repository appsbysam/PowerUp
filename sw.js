...
const CORE=['./','./index.html','./styles.css','./maps-autocomplete.css','./app.js','./maps-config.js','./maps-autocomplete.js','./supabase.js','./version.js','./manifest.webmanifest','./assets/powerup-logo.png','./assets/icons/icon.svg'];
